...
export class TeamService {
  ...
  Team: Team[] = [
    ...
    },
    {
      ...
      Instractor_Info: [
        'خريج قسم الكيمياء الحيوية بكلية العلوم جامعة الإسكندرية بتقدير امتياز مع مرتبة الشرف',
        'ساهم في تطوير أكثر من مدرسة على الإنترنت بدءًا من المراحل الأولى وصولاً إلى المراحل المتقدمة',
        ' مقدم دورات تدريبية للمعلمين حول طرق التدريس المعتمدة على النمط السويدي',
        'خبرة في مجال تطوير المدارس على الإنترنت لمدة 5 سنوات',
        'درّست أكثر من 2000 طالب على الإنترنت وأكثر من 1200 طالب حضورياً',
      ],
      Instractor_VideoUrl:
